            ...
            {loadingClasses ? (
              ...
              <>
                ...
                <div className="space-y-2">
                  <h4 className="font-bold text-xs text-slate-400 uppercase tracking-wider">Lớp đang học ({activeClasses.length})</h4>
                ...
                {/* Past classes */}
                <div className="space-y-2">
                  <h4 className="font-bold text-xs text-slate-400 uppercase tracking-wider">Lớp đã học ({pastClasses.length})</h4>
