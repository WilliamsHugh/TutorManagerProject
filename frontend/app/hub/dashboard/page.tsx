            ...
            <div id="printable-area" className="bg-[#0f172a] p-8 rounded-xl border border-slate-800 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 pt-4 border-t border-slate-800">
                <div className="bg-[#1e293b] p-5 rounded-lg border border-slate-800 text-center space-y-1">
                  ...
                  <h4 className="text-xs text-slate-300 font-semibold h-8 flex items-center justify-center">Tổng số lớp đang hoạt động</h4>
                ...
                <div className="bg-[#1e293b] p-5 rounded-lg border border-slate-800 text-center space-y-1">
                  ...
                  <h4 className="text-xs text-slate-300 font-semibold h-8 flex items-center justify-center">Tổng số yêu cầu mới trong kỳ</h4>
                ...
                <div className="bg-[#1e293b] p-5 rounded-lg border border-slate-800 text-center space-y-1">
                  ...
                  <h4 className="text-xs text-slate-300 font-semibold h-8 flex items-center justify-center">Tổng số gia sư đang hoạt động</h4>
                ...
                <div className="bg-[#1e293b] p-5 rounded-lg border border-slate-800 text-center space-y-1">
                  ...
                  <h4 className="text-xs text-slate-300 font-semibold h-8 flex items-center justify-center">Tổng số học viên đang học</h4>
